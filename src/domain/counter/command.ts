...
export const [newCounter$, newCounter] = eventFactory<NewCounter>({
  entity: MemoryEntity.counter,
  eventType: CounterEvent.new,
})
...
export const [incrementCounter$, incrementCounter] =
  eventFactory<IncrementCounter>({
    entity: MemoryEntity.counter,
    eventType: CounterEvent.increment,
  })
...
export const [finishCounter$, finishCounter] = eventFactory<FinishCounter>({
  entity: MemoryEntity.counter,
  eventType: CounterEvent.finish,
})
